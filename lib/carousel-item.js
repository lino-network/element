...
var CARD_SCALE = 0.83;
var CARD_SCALE_END = 0.73;
var BORDER_SCALE = 0.33;
/* harmony default export */ var itemvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    calcCardTranslate: function calcCardTranslate(index, activeIndex) {
      var p = this.$parent.$el.offsetWidth;
      var a = (p - this.cardWidth) / 2;
      var b = a * BORDER_SCALE;
      var c = p - b - this.cardWidth;
      var d = b - (1 - BORDER_SCALE) * a * 0.5;
      var e = c + (1 - BORDER_SCALE) * a * 0.5;
      if (this.inStage) {
  ...
  computed: {
    ...
    itemStyle: function itemStyle() {
      ...
      var value = translateType + '(' + this.translate + 'px) scale(' + this.scale + ')'; // this.inStage ? this.scale : 0.83
      var style = {
        transform: value,
